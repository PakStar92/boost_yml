 ...
 * });
 */
export function spawnFFmpeg(opts) {
    ...
    const progressParser = parseProgress
        ? new ProgressParser((info) => emitter.emit('progress', info), totalDurationUs)
        : null;
