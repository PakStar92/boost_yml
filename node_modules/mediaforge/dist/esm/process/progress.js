 ...
 */
function buildProgress(block, totalDurationUs) {
    const outTimeUs = parseInt(block['out_time_us'] ?? block['out_time_ms'] ?? '0', 10);
    const progress = (block['progress'] ?? 'continue');
    const info = {
...
export class ProgressParser {
    ...
    onProgress;
    totalDurationUs;
    constructor(onProgress, totalDurationUs) {
 ...
 */
export function parseAllProgress(stderrOutput, totalDurationUs) {
    const results = [];
