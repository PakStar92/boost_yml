 ...
 */
export function isFeatureExpected(featureKey, major, minor = 0) {
 ...
 */
export function availableFeatures(major, minor = 0) {
    return Object.keys(FEATURE_GATES).filter((k) => isFeatureExpected(k, major, minor));
}
/**
 * List features that require a newer version than provided.
 */
export function unavailableFeatures(major, minor = 0) {
    return Object.keys(FEATURE_GATES).filter((k) => !isFeatureExpected(k, major, minor));
}
