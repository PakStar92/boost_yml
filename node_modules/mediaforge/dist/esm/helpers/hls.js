 ...
 * }).run();
 */
export function hlsPackage(opts) {
 ...
 * }).run();
 */
export function adaptiveHls(opts) {
 ...
 * }).run();
 */
export function dashPackage(opts) {
...
export function buildHlsArgs(input, outputDir, opts) {
...
export function buildDashArgs(input, outputPath, opts) {
    const args = ['-y', '-i', input];
    if (opts.videoCodec)
        args.push('-c:v', opts.videoCodec);
    if (opts.audioCodec)
