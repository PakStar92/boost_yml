 ...
 */
export function flattenArgs(entries) {
    const result = [];
 ...
 */
export function toBitrate(value) {
    return String(value);
}
/**
...
export function buildInputArgs(opts) {
    ...
    if (opts.to !== undefined)
        args.push('-to', toDuration(opts.to));
    if (opts.duration !== undefined)
        args.push('-t', toDuration(opts.duration));
    if (opts.extraArgs !== undefined)
        args.push(...opts.extraArgs);
    return args;
}
